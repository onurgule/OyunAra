import 'package:OyunAra/home.dart';
...
class IntroScreenState extends State<IntroScreen> {
 ...
 void initState() {
   ...
   slides.add(
     new Slide(
       title: "Oyun Bul",
       description: "Arkadaşlarınla veya yalnız oynayabileceğin oyunları bulabilirsin.",
   ...
   slides.add(
     new Slide(
       title: "Tam Senlik",
       description: "Oyunları isteğine göre filtreleyip tam senlik oyunları bulabilirsin.",
 ...
 Widget build(BuildContext context) {
   final LocalStorage storage = new LocalStorage('oyunara_first');
   var elem = Column();
   storage.ready.then((_) => elem = actionFor(storage.getItem('launched'),context));
